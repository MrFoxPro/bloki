      ...
      <div class='page landing'>
         ...
         <div class='page-content'>
            <section>
               <div class='intro'>
                  {t().intro}
                  <svg class="decoration intro__place-word" width="249" height="110" viewBox="0 0 249 110" fill="none" >
                     <path class='mark' use:animatedash d="M176.426 7.38803C144.791 4.02688 111.901 2.11459 80.1389 5.52987C58.923 7.81115 30.8167 15.7916 15.8351 32.3888C9.41106 39.5057 4.40987 47.9388 3.33475 57.6148C1.89728 70.5521 8.9232 76.6854 19.3825 83.2913C44.7162 99.2915 73.0914 104.82 102.775 106.152C120.976 106.969 139.211 106.51 157.225 103.562C165.213 102.255 173.034 100.195 180.987 98.7197C191.063 96.8498 201.331 96.4283 211.337 94.1024C225.395 90.8344 248.928 81.4747 244.671 62.5136C240.147 42.3622 216.913 30.97 199.287 24.3931C184.361 18.8238 169.949 12.2289 154.128 9.52774C141.223 7.32452 127.648 8.40158 114.599 8.40158" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                  </svg>
                  <svg class='decoration intro__all-word' width="188" height="31" viewBox="0 0 188 31" fill="none">
                     <path class='mark' use:animatedash d="M3.7793 4.5004C39.9746 1.38683 76.9188 4.31257 113.13 5.06348C134.015 5.49659 154.885 5.91636 175.744 7.09057C176.869 7.15387 183.216 6.60635 184.19 8.55458" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                     <path class='mark' use:animatedash={250} d="M19.9961 15.6504C54.3509 19.3149 88.9357 21.6831 123.321 25.2228C132.91 26.2099 142.447 25.4855 151.757 27.8129" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                  </svg>
            ...
            <section class='feature'>
               ...
               <div class='text'>
                  <div class='heading'>
                     <svg class='decoration workspaces__workspaces-word' width="403" height="38" viewBox="0 0 403 38" fill="none" >
                        <path class='mark' use:animatedash d="M11.6621 7.06728C90.8911 7.06728 169.824 5.3809 249.077 7.75172C299.283 9.25361 349.757 9.54087 399.739 3.9873" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                        <path class='mark' use:animatedash={350} d="M3.0957 19.5205C14.903 21.3848 27.123 20.9572 39.0321 21.98C57.1271 23.5342 75.2833 24.6303 93.4148 25.6693C132.346 27.9004 171.352 28.5288 210.276 30.8958C231.387 32.1796 252.483 34.2182 273.643 34.2776C293.388 34.3331 313.175 34.5831 332.911 33.9702C353.505 33.3306 374.168 33.0479 394.775 33.0479" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                     </svg>
            ...
            <section class='feature'>
               ...
               <div class='text'>
                  <div class='heading'>
                     {t().lib.heading}
                     <svg class='decoration libs__libraries-word' width="371" height="31" viewBox="0 0 371 31" fill="none" >
                        <path class='mark' use:animatedash d="M8.49023 13.1729C12.7349 12.7013 16.9181 12.6535 21.1883 12.6535C39.0941 12.6535 56.9912 12.2688 74.8953 12.1629C121.575 11.8867 168.211 12.6541 214.863 10.5756C252.3 8.90761 289.541 4.83676 326.981 3.30308C339.563 2.78765 352.691 3.82255 364.844 3.82255" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                        <path class='mark' use:animatedash={320} d="M3.29688 27.7186C27.632 27.7186 51.9336 26.4486 76.253 25.6407C116.463 24.3048 156.679 23.4754 196.885 22.0044C236.092 20.57 275.092 22.0044 314.284 22.0044C326.405 22.0044 338.454 21.47 350.531 20.446C356.358 19.9519 362.258 19.6844 367.962 18.3682" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                     </svg>
                  </div>
            ...
            <section class='outro'>
               <div class='start'>
                  ...
                  <svg class='decoration smile' width="62" height="57" viewBox="0 0 62 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path class='mark' use:animatedash={800} d="M13.7129 3C15.1984 7.64236 16.3057 12.4269 17.8338 17.011" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                     <path class='mark' use:animatedash={950} d="M32.6699 4.64844C33.3539 8.44837 33.9437 12.5908 35.1424 16.1869" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                     <path class='mark' use:animatedash={1100} d="M3 41.7357C7.54615 45.2122 11.433 48.2118 17.1484 49.5654C24.2904 51.2569 39.4402 55.9261 45.9029 50.7559C51.0262 46.6572 54.528 42.6519 57.2125 36.5159C57.6626 35.487 58.9473 30.1973 58.2198 30.1973" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                  </svg>
               </div>
               <br />
               <div class='end'>
                  ...
                  <svg class='decoration templates-and-plugins' width="450" height="15" viewBox="0 0 450 15" fill="none"  >
                     <path class='mark' use:animatedash={350} d="M3.0918 11.1786C26.986 6.27725 51.4959 7.98764 75.7752 7.98764C137.914 7.98764 199.975 7.54926 262.093 5.68305C323.572 3.83604 385.13 3.20117 446.638 3.20117" stroke="#FFA61F" stroke-width="6" stroke-linecap="round" />
                  </svg>
               </div>
            </section>
         </div>
