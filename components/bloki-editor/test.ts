import { DEFAULT_FOREGROUND_GRID_WIDTH_FACTOR, DEFAULT_GRID_CELL_GAP_PX, DEFAULT_GRID_CELL_SIZE_PX, DEFAULT_GRID_HEIGHT_FACTOR, DEFAULT_MAIN_GRID_WIDTH_FACTOR } from "./defaults";
